...
for run in 1:1
    for relative_stress in [-0.2, -0.15, -0.1, -0.05, 0, 0.05, 0.1, 0.15, 0.2]
        ...
        filepath_T = string("./output-files/P", pascal_pressure, "sig=", relative_stress, "run", run, "T.csv")
        filepath_Cp = string("./output-files/P", pascal_pressure, "sig=", relative_stress, "run", run, "Cp.csv")
