...
pos_cu78 = [
    [9.20810577, 10.6811792, 12.85775222],
...
cofm =
    [
        sum([pos[1] for pos in pos_cu78]),
        sum([pos[2] for pos in pos_cu78]),
        sum([pos[3] for pos in pos_cu78]),
    ] ./ 78
...
mc_states = [MCState(temp.t_grid[i], temp.beta_grid[i], start_config, pot) for i = 1:n_traj]
