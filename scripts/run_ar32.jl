...
pos_ne32 = pos_ne32 * AtoBohr * 1.2188748503223366

length(pos_ne32) == n_atoms || error("number of atoms and positions not the same - check starting config")

#boundary conditions 
box_length = 8.7674 * AtoBohr * 1.2188748503223366 #Scaling factor for Argon
...
data = [sum(results.ev_histogram[i][:,j] for j=1:100) for i in 1:n_traj]

#data = [results.en_histogram[i] for i in 1:n_traj]


save_resultsNPT(results, "/Users/samuelcase/GIT/PTMC/ParallelTemperingMonteCarlo.jl/data/Ar32_100.0GPa_1000000")
