...
function ptmc_run!(input; startfile="input.data",save::Bool=true,save_dir = pwd())

    mc_states,mc_params,move_strat,pot,ensemble,results,start_counter,n_steps,a,v,r = initialisation(input...; startfile=startfile)
