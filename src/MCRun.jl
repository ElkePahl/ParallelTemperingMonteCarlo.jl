...
export atom_move!
export exc_acceptance, exc_trajectories!, acc_test!, mc_move!, check_e_bounds, reset_counters, equilibration_cycle!, equilibration
...
# end
function get_energy!(mc_state::MCState{T,N,BC,P,E},pot::Ptype,movetype::String) where {T,N,BC,P<:AbstractPotentialVariables,E<:NPTVariables}
    if movetype == "atommove"
